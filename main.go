...
func init() {
	...
	utilruntime.Must(dbupgradev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dbupgrade-controller-manager.subbug.learning",
		...
		// if you are doing or intending to do any work such as perform cleanups
